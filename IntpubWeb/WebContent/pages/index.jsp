				...
				success:function(data){
					if(data.moduleState == 'success'){
						jQuery.each(data.modules, function(i,module){
							var t = menuBar.addMenu(menuBar,module.moduleCode,module.MeduleName,1,null);

							jQuery.each(module.parts, function(j,part){
								var t1 = menuBar.addMenu(t,part.partCode,part.partName,part.partCode,2,module.moduleCode);
							});
